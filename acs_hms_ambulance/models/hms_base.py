...
class AccountMove(models.Model):
    ...
    acs_ambulance_service_id = fields.Many2one('acs.ambulance.service', string='Ambulance Service')
    hospital_invoice_type = fields.Selection(selection_add=[('ambulance', 'Ambulance Service')])
