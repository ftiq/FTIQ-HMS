...
class ACSVaccination(models.Model):
    ...
    move_line_ids = fields.Many2many("account.move.line", "rel_acs_vaccination_move_line", 
                                     "vaccination_id", "move_line_id", string="Vaccination")
    ...
    def get_acs_vaccination_invoice_data(self):
        ...
        for rec in self:
            ...
            product_data.append({
                ...
                'acs_hms_source_type': 'vaccination',
                'acs_vaccination_ids': [rec.id]
            })
        return product_data
    ...
    def view_invoice(self):
        line_invoices = self.move_line_ids.mapped('move_id')
        direct_invoices = self.invoice_id
        invoices = line_invoices | direct_invoices
