...
class LaboratoryRequestView(models.Model):
    ...
    def acs_update_test_lines(self, unlink_existing=True):
    ...
    def create(self, vals_list):
        ...
        records.sudo().acs_update_test_lines(unlink_existing=False)
        return records
    ...
    def write(self, values):
        ...
        if 'lab_test_ids' in values:
            self.acs_update_test_lines(unlink_existing=True)
        return res
