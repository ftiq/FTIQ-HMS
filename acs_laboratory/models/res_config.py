...
class ResCompany(models.Model):
    ...
    acs_lab_req_checkbox_view = fields.Boolean(string="Lab Req Checkbox View", default=False)
...
class ResConfigSettings(models.TransientModel):
    ...
    acs_lab_req_checkbox_view = fields.Boolean(related='company_id.acs_lab_req_checkbox_view', string="Lab Req Checkbox View", readonly=False)
