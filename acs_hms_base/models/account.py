...
class AccountMoveLine(models.Model):
    ...
    acs_patient_amount = fields.Float(string='Patient Amount')
    acs_insurance_amount = fields.Float(string='Insurance Amount')

    # MKA: Added this field to specify the source line type, e.g., Appointment, Procedure, etc.
    acs_hms_source_type = fields.Selection([], string="Source Type")
