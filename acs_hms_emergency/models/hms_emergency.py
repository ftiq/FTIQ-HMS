...
class AcsHmsEmergency(models.Model):
    ...
    _inherit = ['mail.thread', 'mail.activity.mixin', 'acs.hms.mixin', 'acs.document.mixin', 'product.catalog.mixin'] 
    _order = "id desc"
    ...
    def _update_order_line_info(self, product_id, quantity, **kwargs):
        return self.acs_generic_update_order_line_info(model='hms.consumable.line', product_id=product_id, quantity=quantity,link_field='emergency_id', extra_vals={'physician_id': self.physician_id.id})
