...
class ResPartner(models.Model):
    ...
    verified_phone_sms = fields.Boolean(string="Verified SMS", help="The phone number is verified using the SMS message", default=False)
    ...
    def action_send_otp_sms(self):
        for rec in self:
            ...
            if rec.phone and verify_otp_msg_sms_template_id:
