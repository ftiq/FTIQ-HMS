...
#╚══════════════════════════════════════════════════════════════════════╝
{
    'name': 'All - Hospital Management System (All HMS Modules BY AlmightyCS)',
    ...
    'depends': [
        ...
        'acs_hms_consent_hospitalization',
        'acs_commission',
    ...
    'images': [
        'static/description/hms_almightycs_cover.png',
    ],
    'installable': True,
    'application': True,
    'sequence': 1,
