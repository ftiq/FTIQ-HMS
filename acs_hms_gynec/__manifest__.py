...
#╚══════════════════════════════════════════════════════════════════════╝
{
    'name': 'Gynecologist Hospital Management System',
    'version': '1.0.3',
    ...
    'assets': {
        'web.assets_backend': [
            'acs_hms_gynec/static/src/components/*.js',
            'acs_hms_gynec/static/src/components/*.xml',
        ]
    },
    'images': [
        'static/description/hms_gynec_almightycs_cover.png',
    ],
    'installable': True,
    'application': True,
    'sequence': 1,
