...
class AcsChildBirth(models.Model):
    ...
    name = fields.Char('Name of Children', readonly=True, copy=False,default='New')
    ...
    def create(self, vals_list):
        for vals in vals_list:
            if vals.get('name', _("New")) == _("New"):
                ...
                vals['name'] = self.env['ir.sequence'].with_company(vals.get('company_id')).next_by_code('acs.child.birth', sequence_date=seq_date) or _("New")
    ...
    def onchange_hospitalizaion(self):
        if self.hospitalization_id:
            ...
            self.physician_id = self.hospitalization_id.physician_id.id
