...
class ResCompany(models.Model):
    ...
    acs_booking_slot_time = fields.Integer("Website Minutes in each slot", help="Configure your slot length, 15-30min.", default=60)
    acs_allowed_booking_per_slot = fields.Integer("Website Allowed Booking per Slot", help="No of allowed booking per slot.", default=2)
